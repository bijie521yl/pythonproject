...
PRIMARY KEY (`id`),
UNIQUE INDEX `uk_appid` USING BTREE (`appid`) 
)
ENGINE=InnoDB
...
PRIMARY KEY (`id`),
UNIQUE INDEX `uk_sid` USING BTREE (`SourceID`) 
)
ENGINE=InnoDB
DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci
AUTO_INCREMENT=7
...
`seq`  int(11) NOT NULL ,
PRIMARY KEY (`id`),
UNIQUE INDEX `ukey` USING BTREE (`acc_type`, `acc_id`, `col_idx`) 
)
ENGINE=InnoDB
DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci
AUTO_INCREMENT=1
...
PRIMARY KEY (`id`),
UNIQUE INDEX `uk_cid` USING BTREE (`col_id`, `col_from`) ,
UNIQUE INDEX `uk_cname` USING BTREE (`col_name`, `col_from`) 
)
ENGINE=InnoDB
DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci
AUTO_INCREMENT=125
...
`timestamp`  timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '时间戳' ,
PRIMARY KEY (`id`),
UNIQUE INDEX `uk_mid` USING BTREE (`msg_id`) ,
UNIQUE INDEX `uk_md5` USING BTREE (`md5`) ,
INDEX `k_column` USING BTREE (`column`) 
)
ENGINE=InnoDB
DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci
...
PRIMARY KEY (`id`),
UNIQUE INDEX `uk_tid` USING BTREE (`tpl_id`) ,
INDEX `k_tname` USING BTREE (`tpl_name`) 
)
ENGINE=InnoDB
DEFAULT CHARACTER SET=utf8 COLLATE=utf8_general_ci
AUTO_INCREMENT=1
...
-- ----------------------------
ALTER TABLE `t_cms_column` AUTO_INCREMENT=125;
